...
int	ft_atoi_base_exemple(char *str, char *base)
{
	int	s;
	int	i;
	int	res;
...
extern char ft_atoi_base(char *str, char *base);
...
/**ft_atoi_base*/
	char c = 'i';
	char *base = "574924";
	char *str = "        i 519420754";
	printf("str: %s\n, base: %s\n", str, base);
	printf("atoi_base: __[%c]__|[%d]", ft_atoi_base(str, base),ft_atoi_base(str, base));
